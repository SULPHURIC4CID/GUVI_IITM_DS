...
def check_password(password):
    '''
    Function that returns 'True' if password is a valid password else returns 'False'.
    '''
...
def password_requirements():
    ...
    '''
    print("\nThe password needs to satisfy the following.");
    print("1. Contain at least 1 digit.");
    print("2. Contain at least 1 uppercase alphabet.");
    print("3. Contain at least 1 lowercase alphabet.");
    print("4. Contain at least 1 special character.");
    print("5. Length of the password must satisy 5 < length(password) < 16.\n");
